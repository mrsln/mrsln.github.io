        ...
        <div className="flex flex-col items-center flex-grow z-10">
          <div className="w-full flex justify-center mx-auto">
            <div className="w-full max-w-screen-lg lg:w-3/4 lg:space-y-10 pb-10">
              {/* blog */}
              <div className="w-full space-y-8 bg-white border lg:rounded-lg sm:-mt-44 p-10 lg:mb-4 py-12">
              ...
              {/* newsletter */}
              <div className="relative lg:rounded-lg px-6 py-10 bg-indigo-500 overflow-hidden shadow-xl sm:px-12 sm:py-20">
                <div
                  aria-hidden="true"
                ...
                >
                  ...
                  >
                    <path
                      className="text-indigo-300 text-opacity-40"
                      fill="currentColor"
